####-------------------------------####
source('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/
       Magni-PCR-GLOBWB-RF-NEW/source/R/fun_0_loadLibrary.R')
####-------------------------------####
source('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/
       Magni-PCR-GLOBWB-RF-NEW/source/R/2_randomForest/fun_2_2_trainRF.R')
source('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/
       Magni-PCR-GLOBWB-RF-NEW/source/R/2_randomForest/fun_2_3_apply_optimalRF.R')
...
for(subsample in 1:5){
    ...
    testStationInfo <- read.csv(paste0('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/OUTPUT_MAGNI/RF/0_rf_input/subsample_',subsample,'/test_stations.csv'))

    outputDir <- paste0('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/OUTPUT_MAGNI/RF/2_train/subsample_',subsample,'/')
    dir.create(outputDir, showWarnings = F, recursive = T)
    outputDirValidation <- paste0('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/OUTPUT_MAGNI/RF/3_validate/subsample_',subsample,'/')
