...
####-------------------------------####
source('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/Magni-PCR-GLOBWB-RF-NEW/source/R/3_visualization/fun_3_4_hydrograph_fdc_residuals_all.R')
####-------------------------------####
...
for(subsample in 1:5){
    ...
    dir <- paste0('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/OUTPUT_MAGNI/RF/3_validate/subsample_', subsample, '/tables_allpredictors/')

    stationInfo <- read.csv(paste0('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/OUTPUT_MAGNI/RF/0_rf_input/subsample_',subsample,'/test_stations.csv'))

    KGE_table <- read.csv(paste0('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/OUTPUT_MAGNI/RF//3_validate/subsample_',subsample,'/KGE_allpredictors.csv')) %>%
      inner_join(.,read.csv('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/Magni-PCR-GLOBWB-RF-NEW/source/data/stationLatLon.csv') %>% 
                   select(c('grdc_no','miss')), by='grdc_no')

    #### a combined plot test ####
    outputDirCombo <- paste0('/Users/thijskalshoven/Documents/UU_data_science/6_THESIS_Streamflow_predictions/Data/GitHub/OUTPUT_MAGNI/RF/viz/comboPlots/subsample_', subsample, '/')
